...
description: >
    A mobile-first browser using the custom tabs protocol. Change rendering engines, better multi-tasking, floating bubbles, and article mode.  Featured among best browsers on Android.
